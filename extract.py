...
group.add_argument('--sub', action='store_true', help="print subscriber and results")
...
def main():
    for dds in args.dds:
        ...
        net_results = [os.path.join(result_dir, file) for file in files if args.net in file]
        pub_results.sort()
        sub_results.sort()
        net_results.sort()
        ...
        if args.sub:
            ...
            print(t_start, t_ip, t_sub_find_pub, t_first_received)
        ...
        if args.all:
            ...
            #plot_figure(t_start, t_ip, t_pub_find_sub, t_sub_find_pub, t_first_received, t_first_sent, result_dir)
